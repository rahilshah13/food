...
% organ/5
organ(any, 1, skin, [keratinocyte-0.80, fibroblast-0.10, melanocyte-0.05, sebocyte-0.05], 0.16).
organ(any, 2, brain, [astrocyte-0.40, oligodendrocyte-0.30, pyramidal_neuron-0.15, microglia-0.10, ependymal-0.05], 0.02).
organ(any, 3, spinal_cord, [astrocyte-0.40, oligodendrocyte-0.30, pyramidal_neuron-0.10, microglia-0.10, ependymal-0.10], 0.001).
organ(any, 4, heart, [cardiomyocyte-0.70, endothelial-0.15, fibroblast-0.10, smooth_muscle-0.05], 0.005).
organ(any, 5, blood, [erythrocyte-0.90, neutrophil-0.05, t_lymphocyte-0.03, b_lymphocyte-0.02], 0.08).
organ(any, 6, stomach, [parietal-0.40, chief_cell-0.40, smooth_muscle-0.15, endothelial-0.05], 0.005).
organ(any, 7, liver, [hepatocyte-0.80, endothelial-0.10, cholangiocyte-0.05, macrophage-0.05], 0.025).
organ(any, 8, small_intestine, [enterocyte-0.70, goblet-0.15, paneth_cell-0.10, m_cell-0.05], 0.015).
organ(any, 9, large_intestine, [enterocyte-0.70, goblet-0.15, smooth_muscle-0.10, macrophage-0.05], 0.01).
organ(any, 10, lung, [pneumocyte_type_1-0.40, pneumocyte_type_2-0.30, endothelial-0.20, macrophage-0.10], 0.015).
organ(any, 11, kidney, [podocyte-0.40, endothelial-0.40, fibroblast-0.10, macula_densa-0.10], 0.005).
organ(any, 12, bone, [osteocyte-0.85, osteoblast-0.05, osteoclast-0.05, fibroblast-0.05], 0.15).
organ(any, 13, skeletal_muscle, [skeletal_myocyte-0.85, satellite_cell-0.05, fibroblast-0.05, endothelial-0.05], 0.40).
organ(any, 14, cartilage, [chondrocyte-0.90, fibroblast-0.10], 0.005).
organ(any, 15, peripheral_nerve, [schwann_cell-0.80, fibroblast-0.15, endothelial-0.05], 0.005).
organ(any, 16, eye_retina, [photoreceptor-0.70, astrocyte-0.20, melanocyte-0.10], 0.001).
organ(any, 17, cornea, [keratinocyte-0.60, fibroblast-0.30, endothelial-0.10], 0.001).
organ(any, 18, olfactory_epithelium, [pyramidal_neuron-0.60, astrocyte-0.30, fibroblast-0.10], 0.001).
organ(any, 19, inner_ear, [schwann_cell-0.60, fibroblast-0.30, endothelial-0.10], 0.001).
organ(any, 20, tooth, [odontoblast-0.50, ameloblast-0.30, fibroblast-0.15, endothelial-0.05], 0.005).
organ(any, 21, hair_follicle, [trichocyte-0.60, keratinocyte-0.30, melanocyte-0.10], 0.001).
organ(any, 22, sebaceous_gland, [sebocyte-0.80, keratinocyte-0.10, fibroblast-0.10], 0.001).
organ(any, 23, sweat_gland, [keratinocyte-0.70, smooth_muscle-0.20, endothelial-0.10], 0.001).
organ(any, 24, pineal_gland, [astrocyte-0.60, pyramidal_neuron-0.20, endothelial-0.20], 0.001).
organ(any, 25, pituitary_gland, [chromaffin-0.60, endothelial-0.20, fibroblast-0.20], 0.001).
organ(any, 26, esophagus, [keratinocyte-0.60, smooth_muscle-0.30, fibroblast-0.10], 0.003).
organ(any, 27, gallbladder, [cholangiocyte-0.60, smooth_muscle-0.30, fibroblast-0.10], 0.001).
organ(any, 28, pancreas, [acinar_cell-0.80, beta_cell-0.10, alpha_cell-0.05, endothelial-0.05], 0.002).
organ(any, 29, salivary_gland, [acinar_cell-0.70, goblet-0.20, endothelial-0.10], 0.001).
organ(any, 30, tongue, [skeletal_myocyte-0.70, keratinocyte-0.20, fibroblast-0.10], 0.001).
organ(any, 31, pharynx, [skeletal_myocyte-0.60, keratinocyte-0.30, fibroblast-0.10], 0.001).
organ(any, 32, trachea, [goblet-0.50, chondrocyte-0.30, smooth_muscle-0.20], 0.001).
organ(any, 33, bronchus, [goblet-0.40, smooth_muscle-0.40, chondrocyte-0.20], 0.001).
organ(any, 34, larynx, [chondrocyte-0.50, skeletal_myocyte-0.30, goblet-0.20], 0.001).
organ(any, 35, diaphragm, [skeletal_myocyte-0.80, fibroblast-0.10, endothelial-0.10], 0.002).
organ(any, 36, spleen, [macrophage-0.40, t_lymphocyte-0.30, b_lymphocyte-0.20, endothelial-0.10], 0.003).
organ(any, 37, thymus, [t_lymphocyte-0.60, macrophage-0.20, fibroblast-0.20], 0.001).
organ(any, 38, lymph_node, [b_lymphocyte-0.40, t_lymphocyte-0.40, macrophage-0.20], 0.002).
organ(any, 39, bone_marrow, [megakaryocyte-0.40, erythrocyte-0.30, neutrophil-0.20, b_lymphocyte-0.10], 0.03).
organ(any, 40, tonsil, [b_lymphocyte-0.40, t_lymphocyte-0.30, keratinocyte-0.30], 0.001).
organ(any, 41, artery, [smooth_muscle-0.60, endothelial-0.20, fibroblast-0.20], 0.002).
organ(any, 42, vein, [endothelial-0.40, smooth_muscle-0.40, fibroblast-0.20], 0.002).
organ(any, 43, capillary, [endothelial-0.80, fibroblast-0.20], 0.001).
organ(any, 44, lymphatic_vessel, [endothelial-0.70, smooth_muscle-0.30], 0.001).
organ(any, 45, appendix, [enterocyte-0.40, b_lymphocyte-0.30, t_lymphocyte-0.20, goblet-0.10], 0.001).
organ(any, 46, thyroid_gland, [thyroid_foll-0.80, endothelial-0.10, fibroblast-0.10], 0.001).
organ(any, 47, parathyroid_gland, [chief_cell-0.80, endothelial-0.10, fibroblast-0.10], 0.0001).
organ(any, 48, adrenal_gland, [chromaffin-0.70, endothelial-0.20, fibroblast-0.10], 0.001).
organ(any, 49, ureter, [smooth_muscle-0.60, endothelial-0.20, fibroblast-0.20], 0.001).
organ(any, 50, urinary_bladder, [smooth_muscle-0.70, fibroblast-0.20, endothelial-0.10], 0.002).
organ(any, 51, urethra, [keratinocyte-0.50, smooth_muscle-0.40, endothelial-0.10], 0.001).
organ(f, 52, ovary, [granulosa-0.70, oocyte-0.10, oogonium-0.10, endothelial-0.10], 0.001).
organ(m, 53, testis, [spermatogonium-0.40, spermatozoa-0.40, leydig-0.15, endothelial-0.05], 0.001).
organ(f, 54, uterus, [smooth_muscle-0.70, fibroblast-0.20, endothelial-0.10], 0.002).
organ(m, 55, prostate, [acinar_cell-0.60, smooth_muscle-0.30, fibroblast-0.10], 0.001).
organ(f, 56, fallopian_tube, [smooth_muscle-0.60, fibroblast-0.30, goblet-0.10], 0.001).
organ(m, 57, epididymis, [smooth_muscle-0.60, fibroblast-0.30, endothelial-0.10], 0.001).
organ(f, 58, vagina, [keratinocyte-0.60, smooth_muscle-0.30, fibroblast-0.10], 0.001).
organ(m, 59, vas_deferens, [smooth_muscle-0.80, fibroblast-0.20], 0.001).
organ(f, 60, clitoris, [endothelial-0.50, smooth_muscle-0.30, fibroblast-0.20], 0.001).
organ(m, 61, penis, [endothelial-0.50, smooth_muscle-0.30, fibroblast-0.20], 0.001).
organ(f, 62, mammary_gland, [acinar_cell-0.60, fibroblast-0.20, endothelial-0.10, smooth_muscle-0.10], 0.001).
organ(m, 63, seminal_vesicle, [smooth_muscle-0.50, acinar_cell-0.40, fibroblast-0.10], 0.001).
organ(m, 64, bulbourethral, [acinar_cell-0.60, goblet-0.20, fibroblast-0.20], 0.001).
organ(f, 65, placenta, [syncytiotrophoblast-0.60, cytotrophoblast-0.20, endothelial-0.10, macrophage-0.10], 0.005).
organ(any, 66, umbilical_cord, [fibroblast-0.50, endothelial-0.30, smooth_muscle-0.20], 0.001).
organ(any, 67, amnion, [epiblast-0.50, fibroblast-0.30, endothelial-0.20], 0.001).
organ(any, 68, yolk_sac, [hypoblast-0.50, erythrocyte-0.30, endothelial-0.20], 0.001).
organ(any, 69, rectum, [enterocyte-0.60, goblet-0.20, smooth_muscle-0.20], 0.001).
organ(any, 70, anus, [keratinocyte-0.70, smooth_muscle-0.20, melanocyte-0.10], 0.001).
organ(any, 71, ligament, [fibroblast-0.80, chondrocyte-0.20], 0.001).
organ(any, 72, tendon, [fibroblast-0.80, skeletal_myocyte-0.20], 0.001).
organ(any, 73, mesentery, [fibroblast-0.60, endothelial-0.30, macrophage-0.10], 0.001).
organ(any, 74, synovium, [fibroblast-0.60, macrophage-0.30, endothelial-0.10], 0.001).
organ(any, 75, sclera, [fibroblast-0.90, melanocyte-0.10], 0.001).
organ(any, 76, iris, [melanocyte-0.60, smooth_muscle-0.30, endothelial-0.10], 0.001).
organ(any, 77, lens, [keratinocyte-0.90, fibroblast-0.10], 0.001).
organ(any, 78, meninges, [fibroblast-0.70, endothelial-0.20, macrophage-0.10], 0.001).
